...
component tree_reduction is
    ...
    signal flag_t                     : std_logic := '1';
    signal flag_signature_t         : std_logic := '0';
    ...
    signal mux_table_input_t : table := (
         2 => "0000000000000000000001" , --255
         3 => "0000000000000000001010" , 
         4 => "0000000000000000001111" , 
         6 => "0000000000000000000011" , 
         8 => "0000000000000000000110" , 
         9 => "0000000000000000000100" , 
         0 => "0000000000000001001010",
         1 => "0000000000000000000011",
         5 => "0000000000000000100000",
         7 => "0000000000000000000111",
         15=> "0000000000000000000001",

         12 => "0000000000000001001010",
         11 => "0000000000000000001011",
         14 => "0000000000000000000010",
         17 => "0000001000000000000100",
         19 => "0000000000000000000000",

         others => "0000000000000000000111" ) ;
begin
  ...
  --BEGIN
-----------------------------------------------------
    mux_table_input_t <= mux_table_input_t after 100 ns;
    clk_t     <=    not clk_t after 5 ns;
    flag_t     <=    not flag_t after 300 ns;
    reset_t   <=    not reset_t after 700 ns;

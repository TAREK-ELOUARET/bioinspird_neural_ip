...
entity tree_reduction is
  ...
  port (
	...
	reset                    : in std_logic;
  	...
  	mux_table_output         : out table_of_line_max_WTA
  	);
...
begin
    ...
    tree_reduction : process (clk, mux_table_input, flag)
       variable active_neuron_variable : natural := 0;
       variable number_of_ligne  : natural;
       variable cnt : natural := 0;
       variable mux_table_t_t : table_of_line_max_WTA;
      ...
      if rising_edge(clk) then   
       ...
       for i in 0 to NUMBER_OF_ACTIVE_NEURONS_SIGNATURE - 1 loop
            ...
            mux_table_t_t(i) := mux_table_t(number_of_ligne);
        end loop;
        
        flag_signature_t := '1'; 
        mux_table_output <= mux_table_t_t;
